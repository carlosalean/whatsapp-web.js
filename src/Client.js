...
class Client extends EventEmitter {
    constructor(options = {}) {
        ...
        this.linkingMethod = options.linkingMethod || new LinkingMethod({
            qr: {
    ...
    async initialize() {
        ...
        if (needAuthentication) {
            ...
            const handleLinkWithPhoneNumber = async () => {
                const LINK_WITH_PHONE_BUTTON = '#app > div > div.landing-wrapper > div.landing-window > div.landing-main > div > div > div._amrn > div > span';
                const PHONE_NUMBER_INPUT = '#app > div > div.landing-wrapper > div.landing-window > div.landing-main > div > div.x1c4vz4f.xs83m0k.xdl72j9.x1g77sc7.x78zum5.xozqiw3.x1oa3qoh.x12fk4p8.xeuugli.x2lwn1j.x1nhvcw1.xdt5ytf.x1qjc9v5 > div.x1c4vz4f.xs83m0k.xdl72j9.x1g77sc7.x78zum5.xozqiw3.x1oa3qoh.x12fk4p8.xeuugli.x2lwn1j.x1nhvcw1.xdt5ytf.x1qjc9v5 > div.x1c4vz4f.xs83m0k.xdl72j9.x1g77sc7.xeuugli.x2lwn1j.xozqiw3.x1oa3qoh.x12fk4p8.x1iymm2a > div > div > div > form > input';
                const NEXT_BUTTON = '#app > div > div.landing-wrapper > div.landing-window > div.landing-main > div > div.x1c4vz4f.xs83m0k.xdl72j9.x1g77sc7.x78zum5.xozqiw3.x1oa3qoh.x12fk4p8.xeuugli.x2lwn1j.x1nhvcw1.xdt5ytf.x1qjc9v5 > div.x1c4vz4f.xs83m0k.xdl72j9.x1g77sc7.xeuugli.x2lwn1j.xozqiw3.xamitd3.x12fk4p8.x1hq5gj4 > button';
                const CODE_CONTAINER = '#app > div > div.landing-wrapper > div.landing-window > div.landing-main > div > div > div._ak96 > div';
                const GENERATE_NEW_CODE_BUTTON = '#app > div > span > div > div > div > div > div > div > div.x78zum5.x8hhl5t.x13a6bvl.x13crsa5.x1mpkggp.x18d9i69.x1t2a60a.xp4054r.xuxw1ft > div > button';
                ...
                const phoneNumber = this.linkingMethod.phone ? this.linkingMethod.phone.number : null;
                ...
                const typePhoneNumber = async () => {
                    ...
                    await page.type(PHONE_NUMBER_INPUT, phoneNumber);
                };
            ...
            const { linkingMethod } = this;

            if (linkingMethod && linkingMethod.isQR()) {
                await handleLinkWithQRCode();
            } else if (linkingMethod && linkingMethod.isPhone()) {
                await handleLinkWithPhoneNumber();
            } else {
                throw new Error('Invalid linking method configuration');
            }
